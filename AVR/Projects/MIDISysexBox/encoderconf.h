...
#define ENC0_PHASEA_PORT			PORTB	// PhaseA port register
#define ENC0_PHASEA_DDR				DDRB	// PhaseA port direction register
...
// *** PORTx, DDRx, PINx, and Pxn should all have the same letter for "x" ***
#define ENC0_PHASEB_PORT			PORTB	// PhaseB port register
#define ENC0_PHASEB_DDR				DDRB	// PhaseB port direction register
